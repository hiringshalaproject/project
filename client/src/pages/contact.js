...
return (
<>
 <div className="mt-20 mx-4 lg:px-16 mb-20">
    <div className="relative isolate overflow-hidden bg-gray-100 py-24 sm:pt-16  mb-2 rounded-3xl">
    <img
        src={contactUs}
        alt=""
        className="absolute inset-0 -z-10 object-cover h-full blur-sm lg:blur-0"
      />
    <div
      ...
      >
        ...
        <div className="mx-auto max-w-7xl px-6 lg:pl-[390px] lg:pr-6">
     ...
     <div>
     <div className="relative isolate overflow-hidden bg-gray-100 rounded-3xl mb-2">
    <div
        className="hidden sm:absolute sm:-top-10 sm:right-1/2 sm:-z-10 sm:mr-10 sm:block sm:transform-gpu sm:blur-3xl"
        aria-hidden="true"
      >
